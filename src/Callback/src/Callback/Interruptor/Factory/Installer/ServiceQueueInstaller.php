...
use rollun\callback\Callback\Interruptor\Factory\ServiceQueueAbstractFactory;
use rollun\callback\Callback\Multiplexer;
use rollun\installer\Install\InstallerAbstract;

class ServiceQueueInstaller extends InstallerAbstract
{
    /**
     * install
     * @return array
    ...
    public function install()
    {
        $config = [
            'dependencies' => [
                'abstract_factories' => [
					ServiceQueueAbstractFactory::class,
                ],
            ],
        ];
    ...
    public function isInstall()
    {
        ...
        $result = (
            ...
            in_array(ServiceQueueAbstractFactory::class, $config['dependencies']['abstract_factories'])
        );
        /*if($result) {
    ...
    public function getDescription($lang = "en")
    {
        switch ($lang) {
            case "ru":
                $description = "Предоставляет возможность использовать";
                break;
            default:
